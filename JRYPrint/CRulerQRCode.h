...
namespace SOUI
{
	class CRulerQRCode : public SWindow
	{
		SOUI_CLASS_NAME(CRulerQRCode, L"rulerqrcode")
	public:
		CRulerQRCode();
		~CRulerQRCode();
	...
	public:
		...
		void SetQRContent(SStringW& sstrContent);
		SStringW GetQRContent();
